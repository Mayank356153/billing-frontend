...
const ItemList = () => {
  ...
  const handleBulkCreate = async () => {
    try {
      ...
      await axios.post('https://pos.inspiredgrow.in/vps/1items/bulk-create', { items: itemsToSave });
  ...
  const handleBulkDelete = async () => {
    if (window.confirm(`Are you sure you want to delete ${selectedItems.length} items?`)) {
      try {
        await axios.post('https://pos.inspiredgrow.in/vps/1items/bulk-delete', { ids: selectedItems });
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this item?")) {
      try {
        ...
        await axios.delete(`https://pos.inspiredgrow.in/vps/1items/${id}`);
